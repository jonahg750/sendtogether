    ...
    <div className="flex flex-col items-center min-h-screen px-5 py-12 bg-white dark:bg-gray-900">
      <div className="w-full max-w-xl">
        ...
        <div className="space-y-6 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">What SendTogether is</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">Gmail access</h2>
            <p>By signing in with Google, you grant SendTogether temporary permission to send one email on your behalf using the Gmail API. We request only the <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">gmail.send</code> scope. We never read your inbox or store your credentials. Your access token exists only in your browser session and is discarded after use.</p>
          </section>

          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">No warranties</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">Limitation of liability</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">Changes to these terms</h2>
            <p>We may update these terms from time to time. Continued use of the service after changes constitutes acceptance of the updated terms.</p>
          </section>

          <section>
            <h2 className="font-semibold text-gray-900 dark:text-white mb-2">Contact</h2>
            <p>Questions? Contact us at <a href="mailto:hello@sendtogether.app" className="text-blue-600 dark:text-blue-400 underline">hello@sendtogether.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
