    ...
    <div className="flex flex-col items-center min-h-screen px-5 py-12">
      <div className="w-full max-w-xl">
        ...
        <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">What SendTogether does</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">Google account access</h2>
            <p>When you sign in with Google, we request permission to <strong>send email on your behalf</strong> using the Gmail API (<code className="bg-gray-100 px-1 rounded">gmail.send</code> scope). This is the only permission we request.</p>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">What we store</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">Cookies and tracking</h2>
          ...
          <section>
            ...
            <p>For questions or deletion requests, contact us at <a href="mailto:hello@sendtogether.app" className="text-blue-600 underline">hello@sendtogether.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
